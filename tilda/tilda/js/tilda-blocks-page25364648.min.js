...
function t902_init(recId){var rec=document.getElementById('rec'+recId);if(!rec)return;var container=rec.querySelector('.t902');if(!container)return;t902_unifyHeights(recId);window.addEventListener('resize',t_throttle(function(){t902_unifyHeights(recId)}));container.addEventListener('displayChanged',function(){t902_unifyHeights(recId)})}
